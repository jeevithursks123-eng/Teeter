...
- Works best on devices with:
  - Functional accelerometer (tilt sensor)
  - Standard screen scaling support
...
- Some devices may experience:
  ...
  - Limited or no vibration support (device dependent)
- Gameplay depends heavily on sensor accuracy
...
Enjoy the game and relive the classic mobile gaming experience 🎯
